...
The [OpenFeature client](/specification/glossary#client) is a lightweight abstraction used to evaluate feature flags, implemented by every SDK.
...
Within the scope of this React provider, all flag evaluation hooks will make use of the bound OpenFeature client and its associated [OpenFeature provider](/specification/glossary#provider).
...
The most fundamental feature of the React SDK is support for re-rending components using feature flags when the effective values of those flags change.
