...
class MyHook(Hook):
    def before(self, context: HookContext, hints: dict):
        ...  # code to run before flag evaluation

    def after(self, context: HookContext, details: FlagEvaluationDetails, hints: dict):
        ...  # code to run after successful flag evaluation

    def error(self, context: HookContext, error, hints: dict):
        ...  # code to run if there's an error during before hooks or during flag evaluation

    def finally_after(self, context: HookContext, hints: dict):
        ...  # code to run after all other stages, regardless of success/failure
```
