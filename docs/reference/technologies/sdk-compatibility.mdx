...
import { serverSideFeatures, clintSideFeatures } from '@site/src/datasets/constants';
...
<SdkCompatibilityTable compatibility={Json.filter(sdk => sdk.category === 'Client')} features={clintSideFeatures}/>
